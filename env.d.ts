...
declare module "https://esm.sh/monaco-textmate@3.0.1" {
    export { default } from "monaco-textmate"
}

declare module "https://esm.sh/qingkuai@1.0.41/compiler" {
    export * from "qingkuai/compiler"
}

declare module "https://esm.sh/monaco-editor-textmate@4.0.0" {
    export { default } from "monaco-editor-textmate"
}
...
declare module "https://esm.sh/qingkuai-language-service@1.0.6" {
    export * from "qingkuai-language-service"
}

declare module "https://esm.sh/vscode-languageserver-types@3.17.5" {
    export * from "vscode-languageserver-types"
}

declare module "https://esm.sh/qingkuai-language-service@1.0.6/adapters" {
